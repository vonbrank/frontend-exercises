    ...
    <section className="section-features">
      <div className="container features__container">
        <div className="features__content">
          <span className="heading-secondary--sub lazy"> ABOUT US</span>
        ...
        <div className="feature__img-container">
          <img
            src="https://vonbrank-images.oss-cn-hangzhou.aliyuncs.com/20220630-OneMoreClipWebPage/home/cat.jpg"
